...
function HZTablePart:operationCard(data)
	...
	print("This is HZTablePart AN_GANG:",bit._and(data.operation,MahjongOperation.AN_GANG),MahjongOperation.AN_GANG)
	print("This is HZTablePart MING_GANG:",bit._and(data.operation,MahjongOperation.MING_GANG),MahjongOperation.MING_GANG)
